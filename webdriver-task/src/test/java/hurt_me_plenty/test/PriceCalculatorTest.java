...
import hurt_me_plenty.pages.CloudGoogleMainPage;
...
public class PriceCalculatorTest {
	...
	public void SetUp(){
        ...
        .switchToFrame()
        .fillOutForm(NUMBER_OF_INSTANCES, INSTANCES_FOR, OPERATING_SYSTEM, VM_CLASS, INSTANCE_TYPE, NUMBER_OF_GPUs, GPU_TYPE, LOCAL_SSD, DATACENTER_LOCATION, COMMITED_USAGE);
    }
