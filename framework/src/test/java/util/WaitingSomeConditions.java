...
public class WaitingSomeConditions {
  ...
  public static WebElement waitForElementVisibilityOf(WebDriver driver, WebElement element, int timeout) {
  ...
  public static void waitForJquery(WebDriver driver){
	new WebDriverWait(driver, Duration.ofSeconds(WAIT_TIMEOUT_SECONDS)).until(new ExpectedCondition<Boolean>() {
      @Override
