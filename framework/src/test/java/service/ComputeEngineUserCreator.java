...
public class ComputeEngineUserCreator {
	...
	public static ComputeEngineUser UserFromTaskHardcore() {
		return new ComputeEngineUser( Integer.parseInt(TestDataReader.getTestData(TESTDATA_NUMBER_OF_INSTANCES)), 
